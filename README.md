# نخيل نجد — V6.3 CMS Cinematic / Render Ready
...
هذه النسخة تضيف هوية سينمائية أصلية خاصة بنخيل نجد: فيديو رئيسي كامل الشاشة، نظام بصري أسود/عاجي موحّد لكل الصفحات، حركة GSAP + Lenis، ومخطط تغطية تفاعلي بـHighcharts. الأقسام الثابتة في الرئيسية صارت مدارة من Django Admin بدون الحاجة لتعديل الكود.
...
- إدارة كاملة من Django Admin للصفحات، الصور، المشاريع، الخدمات، المدن، SEO، وإثات ملكية الموقع.
